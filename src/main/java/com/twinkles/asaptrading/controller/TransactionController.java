...
public class TransactionController {
    ...
    @GetMapping(value = "/admin/pending/buys", produces = MediaType.APPLICATION_JSON_VALUE)
    ...
    @PreAuthorize("hasAnyRole('ROLE_ADMIN')")
    @GetMapping(value = "/admin/pending/sells", produces = MediaType.APPLICATION_JSON_VALUE)
    ...
    @PreAuthorize("hasAnyRole('ROLE_ADMIN')")
    @PostMapping(value = "/{transactionId}/update/{status}", produces = MediaType.APPLICATION_JSON_VALUE)
